...
from test123test234.configuration import Configuration
from test123test234.api_response import ApiResponse, T as ApiResponseT
import test123test234.models
from test123test234 import rest
from test123test234.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(test123test234.models, klass)
