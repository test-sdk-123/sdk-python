...
from test-123.configuration import Configuration
from test-123.api_response import ApiResponse, T as ApiResponseT
import test-123.models
from test-123 import rest
from test-123.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(test-123.models, klass)
